...
namespace Homework
{
     ...
     * конструктор и зачем он нужен - специальные методы, которые называются так же, как и класс
     и вызываются при создании нового объекта класса. В конструктор помещают начальные значения переменных экземпляра класса, 
